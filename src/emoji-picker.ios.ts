import { EmojiPickerBase, textProperty, popupProperty } from "./emoji-picker.common";
...
export class MyButton extends EmojiPickerBase {
    ...
    [popupProperty.getDefault](): number {
        return this.nativeView.alpha;
    }

    // set opacity to the native view.
    [popupProperty.setNative](value: number) {
